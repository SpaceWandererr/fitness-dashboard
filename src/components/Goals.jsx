...
export default function Goals() {
             ...
             render={(card) => (
                  <div className="space-y-2">
                   ...
                   <ul className="text-xs opacity-70 space-y-1">
                     {card.items.map((i, n) => <li key={n}>• {i}</li>)}
                   </ul>
  ...
  const fitnessWrapper = [
    {
      render: () => (
        <motion.div whileHover={{ scale: 1.02 }} className=" min-h-[230px] relative rounded-xl p-4 border border-white/5 bg-[rgba(15,20,30,0.45)] backdrop-blur-xl shadow-lg overflow-hidden">
          {/* soft NZ-style holo bars (50% softer glow) */}
          <div className="absolute left-0 top-0 h-full w-[4px] rounded-r-lg" style={{ background: "linear-gradient(to bottom, rgb(147,197,253), rgb(34,211,238), rgb(134,239,172))", boxShadow: "0 0 3px rgba(34,211,238,0.45), 0 0 18px rgba(134,239,172,0.40)", opacity: 0.95 }} />
          <div className="absolute bottom-0 left-0 w-full h-[4px]" style={{ background: "linear-gradient(to bottom, rgb(147,197,253), rgb(34,211,238), rgb(134,239,172))", boxShadow: "0 0 3px rgba(34,211,238,0.45), 0 0 18px rgba(134,239,172,0.40)", opacity: 0.95 }} />
  ...
  const routineWrapper = [
    {
      render: () => (
        <motion.div whileHover={{ y: -4 }} className="min-h-[260px] rounded-xl p-5 border border-white/5 bg-[rgba(15,20,30,0.45)] backdrop-blur-xl shadow-lg relative overflow-hidden">
  ...
  const dreamWrapper = [
    {
      render: () => (
        <motion.div whileHover={{ scale: 1.02 }} transition={{ duration: 0 }} className="min-h-[240px] rounded-xl p-3 border border-white/5 bg-[rgba(15,20,30,0.45)] backdrop-blur-xl shadow-lg relative overflow-hidden">
          {/* soft NZ-style holo bars */}
          <div className="absolute left-0 top-0 h-full w-[4px] rounded-r-lg" style={{ background: "linear-gradient(to bottom, rgb(147,197,253), rgb(34,211,238), rgb(134,239,172))", boxShadow: "0 0 3px rgba(34,211,238,0.45), 0 0 18px rgba(134,239,172,0.40)", opacity: 0.95 }} />
          <div className="absolute bottom-0 left-0 w-full h-[4px]" style={{ background: "linear-gradient(to bottom, rgb(147,197,253), rgb(34,211,238), rgb(134,239,172))", boxShadow: "0 0 3px rgba(34,211,238,0.45), 0 0 18px rgba(134,239,172,0.40)", opacity: 0.95 }} />
  ...
  return (
    <div className=" w-full min-h-screen relative overflow-hidden bg-background text-foreground transition-colors rounded-2xl -mt-4">
      ...
      <main className="max-w-6xl mx-auto px-6 pb-20">
        ...
        style={{ textShadow: "0 6px 30px rgba(0,0,0,0.6), 0 0 18px rgba(40,200,180,0.06)" }}
       >
