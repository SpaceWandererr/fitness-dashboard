...
export default function CalendarFullDarkUpdated() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-3 grid grid-cols-1 lg:grid-cols-[1.7fr,1fr] gap-4 items-start transition-colors duration-500 bg-[#0b1220] rounded-xl">
      ...
      <div className="lg:col-span-3 flex flex-col gap-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="rounded-xl p-4 border bg-gradient-to-br from-[#071022] to-[#081427] shadow-md transition-all duration-300 text-white">
            <div className="text-sm font-semibold text-[#e50914] mb-1">
              📊 Today's Stats
            </div>
          ...
          {[
            ...
            <button
              ...
              className={`w-full py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
                view === btn.val
                  ? "bg-black  text-[#e50914] shadow-[0_4px_20px_rgba(0,149,255,0.18)]"
                  : "bg-[#0c0c0c] hover:bg-[#1a1a1a] text-gray-300"
              }`}
            >
              {btn.label}
            </button>
      ...
      {/* Calendar Section */}
      <div className="lg:col-span-2 rounded-2xl border border-[#05070c] p-3 bg-[#071022] space-y-6 min-w-[650px] min-h-[600px]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <button
              onClick={() => setMonth((m) => m.subtract(1, "month"))}
              className="px-2 py-1 rounded bg-black text-[#e50914] hover:scale-105 transition-transform"
            >
              ◀
            </button>
            <h2 className="text-lg font-semibold text-[#e50914]">
              {month.format("MMMM YYYY")}
            </h2>
            <button
              onClick={() => setMonth((m) => m.add(1, "month"))}
              className="px-2 py-1 rounded bg-black text-[#0ea5ff] hover:scale-105 transition-transform"
            >
              ▶
            </button>
          </div>
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1 rounded bg-black text-[#e50914]"
            >
              Today
            </button>
        ...
        <div className="grid grid-cols-7 gap-2 bg-[#0b1220]">
          {days.map((d) => {
            const iso = d.format("YYYY-MM-DD");
            ...
            const bgClass =
              status === "both"
                ? "bg-gradient-to-br from-[#e50914] to-[#e11d48] text-white"
                : status === "study"
            ...
            return (
              <button
                ...
                className={`${base} ${notCur} ${bgClass} ${
                  isSelected
                    ? "!bg-[#15304f] ring-2 ring-[#3b82f6] ring-offset-0 ring-offset-transparent shadow-none scale-105"
                    : "hover:scale-105"
                }`}
              ...
              >
                <div
                  className={`relative flex items-center justify-center w-full h-full ${
                    isToday
                      ? "before:absolute before:inset-0 before:rounded-xl before:ring-0 before:ring-transparent before:animate-none"
                      : ""
                  }`}
                >
                  <span>{d.date()}</span>
        ...
        <div className="rounded-xl p-3 border bg-[#071227] transition-all">
          <h4 className="font-semibold text-[#e50914] mb-2">📝 Notes</h4>
          <textarea
            value={selectedNote}
      ...
      <div className="rounded-2xl border p-3 bg-[#071022] space-y-3 min-h-[600px] min-w-[450px]">
        <div className="text-sm text-[#e50914] mb-2">
          {dayjs(selectedDate).format("dddd, DD MMM YYYY")}
        </div>

        <div className="rounded-2xl p-3 border bg-[#071827]">
          <h4 className="font-semibold text-[#e50914] mb-2">Day Summary</h4>
          <div className="grid grid-cols-5 text-center mt-2">
            <div>
              <p className="text-[#e50914] font-semibold">
        ...
        <div className="rounded-xl p-3 border bg-[#071427] min-h-[160px]">
          <h4 className="font-semibold text-[#e50914] mb-2">🏋️ Gym Summary</h4>
